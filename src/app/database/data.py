...
MODULE_TYPES = [
    ...
    ModuleType(id=9, name="Baseball", w=2, h=1, massKg=1.1, subscription_plan_option_id=2),
    ModuleType(id=10, name="Baseball bat", w=1, h=2, massKg=2.4, subscription_plan_option_id=2),
    ...
    ModuleType(id=16, name="Baseball", w=2, h=1, massKg=1.1, subscription_plan_option_id=3),
    ModuleType(id=17, name="Baseball bat", w=1, h=2, massKg=2.4, subscription_plan_option_id=3),
